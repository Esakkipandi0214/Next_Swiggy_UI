...
const intersectionDiv = (props) => {
    ...
    <figure><Image src={lists.dish} alt="Shoes" className=' h-40 my-4 w-full rounded-xl' /></figure>
    ...
    <div className='flex'><Image src={star} alt="Shoes" className=' w-5 h-5 my-2' /><span className=' mx-2 my-1 text-black font-bold flex'>{lists.time}</span></div> 
