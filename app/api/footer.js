...
import swiggy from '../../public/swiggyWhite.png'
  ...
  return (
    <div className=' h-400px bg-black items-center flex justify-center p-8'>
        ...
        <div className='grid grid-rows-2 -translate-y-16'>
            <div className=' flex translate-y-2 -mx-6'><Image src={swiggy} alt="" className=" bg-white mx-3 h-14" /><p className='text-white translate-y-3 text-2xl font-extrabold'>Swiggy</p></div>
        ...
        <div className='-translate-y-10'>
            ...
            <p className=' text-slate-300 text-base font-normal my-3'><Link href="/Home" className=' '><h3 className=' list-none text-slate-300 text-base font-normal'>About</h3></Link></p>
        ...
        <div className='-translate-y-10'>
            ...
            <div className='border-slate-700 border-2 h-10 flex items-center rounded-xl '><button className=' mx-2 bg-white text-slate-300 text-base font-normal shadow-md rounded-lg h-14 bg-transparent text-center content-center font-sans'>589 Cities</button></div> 
        </div>
        </div>
    </div>
  )
