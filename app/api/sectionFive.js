...
const sectionFive = () => {
  ...
  return (
    <div className=' h-62 p-9 mx-28 my-0'>
        ...
        <div className=' grid grid-cols-4 gap-12 my-6'>
            ...
            <button  id='btn1' onClick={()=>loadMore()} className='bg-white text-black shadow-md rounded-lg h-14 border-slate-600 text-center content-center font-sans'>show More</button>   
        </div>
    </div>
  )
}
